...
const About = () => {
  const teamMembers = [
    {
      ...
      description: 'A true friend and brother, working together to achieve our common goals.',
    },
    {
      name: 'Jane Smith',
  ...
  return (
    ...
    <h1 className="text-5xl text-center font-bold text-blue-700 pb-14">About Us</h1>
      {/* About Section */}
      ...
      >
        ...
        <p className="text-lg text-gray-600 mb-6">
          At <strong>Electro Mart</strong>, we envision a world where technology
          is not just a luxury but an essential tool accessible to everyone. Our goal is to bridge the gap between technological advancements and the everyday consumer by making cutting-edge electronics affordable and within reach.
        </p>
        <p className="text-lg text-gray-600 mb-6">
          We are also committed to sustainability, ensuring that our products
          are sourced ethically and produced with minimal environmental impact. Our mission is to foster community engagement by partnering with local organizations and investing in eco-friendly initiatives to make a positive impact on the planet.
        </p>
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
           <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180601/znxp9yobjqu0rxmxqwpm.png" className="h-10" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
            <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/rqonzvztv45fhdufrnff.png" className="h-12" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
            <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/trakr75zy7clyubpffxs.png" className="h-11" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
           <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/deexfnlvbarne9wdgwex.png" className="h-9" alt="" />
          </span> 
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/gx3s4sxpquwhxsbrfmvl.png" className="h-10" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/vhpmwjr59ljhcfwivyix.png" className="h-20" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180600/qppraopfkwuotquszqrp.png" className="h-12" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180599/d0d2crlrfj98f6qe1fwb.png" className="h-11" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180599/cchhqsppvpmcz4jmyoet.png" className="h-16" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180599/qlnvltrvplemspnr4gae.png" className="h-7" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180599/sexwjpglzbhfxpcx1rc6.png" className="h-12" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730180599/skfcatgbv5bgtcw3vd7z.png" className="h-10" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730181208/bf6ymdvhzc00n5zxphga.png" className="h-10" alt="" />
          </span>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-10">
          <span className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-800 font-semibold">
          <img src="https://res.cloudinary.com/dvubt5hiv/image/upload/v1730181208/addlpj0ivoa1yyjqlul7.png" className="h-16 pr-3" alt="" />
          </span>
        </div>
