                        ...
                        <SwiperSlide key={idx}>
                            <Link to={'/'} className="relative">
                               ...
                               <img
                                    src={slide.url}
                                    alt={`slide ${idx + 1}`}
                                    className="w-full cursor-pointer lg:min-h-[300px] md:max-h-[300px] lg:max-h-[370px] h-[50vh] md:h-auto rounded-lg object-contain md:object-right lg:object-fill"
                                />
