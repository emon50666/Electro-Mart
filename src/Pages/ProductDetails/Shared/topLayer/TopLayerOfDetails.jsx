...
const TopLayerOfDetails = ({ title, id }) => {
    ...
    return (
        ...
        <nav className="lg:flex hidden sm:block  flex-col md:flex-row justify-between items-start md:items-center px-4 lg:px-8 xl:px-20 bg-slate-300 py-3" id="product_details_top_layer">
            <ul className="lg:flex  flex-col md:flex-row gap-1 font-semibold font_open_sense items-center text-[10px] md:text-base lg:text-[15px] text-gray-900">
                ...
                <li className="items-center  flex text-gray-900">
                    <Link to="#" className="hover:text-gray-600">{title.slice(0,150)+'...'}</Link>
                </li>
            </ul>
