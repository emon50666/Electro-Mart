    ...
    <div className="navbar bg-base-100 sticky top-0 z-40 md:px-10">
      ...
      >
        <input
          ...
          className="border-l border-t border-b border-blue-400 w-96 xl:w-[700px] pt-2 pb-2 px-2 py-2 border-dashed rounded-l-full focus:outline-none  focus:bg-blue-50/30 outline-blue-400 focus:ring-0"
        />
