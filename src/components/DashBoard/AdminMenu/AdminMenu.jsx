        ...
        <ul className="flex font-serif flex-1 flex-col mt-10 gap-1 py-3">
          <li className="px-3">
            <Link
              ...
              className="flex text-[16px] items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-orange-50 hover:text-orange-500 focus:bg-orange-50 aria-[current=page]:bg-orange-50 aria-[current=page]:text-emerald-500 "
            >
          ...
          <li className="px-3 group relative">
            ...
            <ul className="absolute  w-full  top-full hidden group-hover:block bg-white shadow-lg rounded-lg p-2">
              ...
              <li className="px-3">
                <Link
                  to="addProduct"
                  className="block py-2 px-4 text-sm font-medium text-slate-700 hover:bg-orange-50 hover:text-orange-500"
                >
                  Add New Product
                </Link>
              </li>
          ...
          <li className="px-3">
            <Link
              ...
              className="flex items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-orange-50 hover:text-orange-500 focus:bg-orange-50 aria-[current=page]:bg-orange-50 aria-[current=page]:text-emerald-500 "
            >
