  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className={`visible fixed right-2 top-12  z-50 order-10 block h-10 w-10 self-center rounded  shadow-md bg-[#c6c6c6] opacity-100 lg:hidden ${isSideNavOpen
      ...
      {/*  <!-- Backdrop --> */}
      <div
        className={`fixed top-0 mt-10 bottom-0 left-0  right-0 z-30 bg-slate-900/20 transition-colors sm:hidden ${isSideNavOpen ? "block" : "hidden"
          }`}
