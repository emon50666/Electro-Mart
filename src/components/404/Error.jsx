    ...
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="text-center p-6 shadow-md rounded-md">
        ...
        <div className="flex justify-center items-center">
          <FaShoppingCart className="text-6xl text-blue-500 mb-6" />
        </div>
        ...
        {/* Back to Home Button */}
        <Link to="/" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-full transition-colors">
          Go Back Home
        </Link>
      </div>
    </div>
