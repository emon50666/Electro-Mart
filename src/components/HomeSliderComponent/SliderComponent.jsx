  ...
  return (
    <div className="relative mt-10 mb-10 w-full lg:h-[500px] md:h-[400px] flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://res.cloudinary.com/dpsgtszzi/image/upload/v1730362292/Screenshot_12_lsg84f.png')",
        }}
      ></div>
      ...
      >
        ...
        <p className="mt-2 md:mt-4 text-[12px] md:text-md">
          Wireless mechanical keyboard designed for comfort and style with
          ethereal RGB lighting and full media controls at your fingertips.
        </p>
        <button className="mt-4 underline hover:translate-x-1 duration-700 flex items-center text-[#2F3132] font-semibold rounded">
          Shop G715 Now{" "}
          <IoMdArrowDropright className="items-center mt-1 text-xl"></IoMdArrowDropright>
        </button>
      </div>
    </div>
  );
